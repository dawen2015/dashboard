    ...
    <form @submit.prevent="handleSubmit">
      ...
      <div class="row">
        <div class="form-group input-container col-12">
          ...
          />
          <div
            v-show="submitted && ! currentUser.address"
        ...
        <div class="form-group input-container col-6">
          ...
          <div class="select-container">
            <select
              ...
              name="state"
              class="form-control input-field select-field"
      ...
      <div class="row">
        <div class="form-group input-container col-6">
          ...
          />
          <div
            v-show="submitted && ! currentUser.zipcode"
            class="invalid-feedback"
        ...
        <div class="form-group input-container col-6">
          ...
          <div
            v-show="submitted && ! currentUser.state"
            class="invalid-feedback"
      ...
      <div class="row">
        <div class="form-group input-container col-6">
          ...
          />
          <div
            v-show="submitted && ! currentUser.dob"
            class="invalid-feedback"
      ...
      <div class="row">
        <div class="form-group input-container col-6">
          ...
          />
          <div
            v-show="submitted && ! currentUser.sourceoffund"
            class="invalid-feedback"
          >Source of funds is required</div>
        </div>
      </div>

      <div class="footer-info">
        <div style>
          <input type="checkbox" id="acknowlege" name="acknowledge" />
          <span class="acknowlege-text">Yes, I am an accredited investor</span>
        </div>
      </div>

      <div class="footer-info">
        <div class="next-btn" :disabled="loading">
          NEXT
